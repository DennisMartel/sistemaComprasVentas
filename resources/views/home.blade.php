        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card text-white bg-warning">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>${{$total->totalcompra}} (DIA ACTUAL)</strong>
                    </div>
                    <div class="h3">Compras</div>
                </div>
                <div class="chart-wrapper mt-3 mx-3" style="height:35px;">
                    <a href="{{route('purchases.index')}}" class="small-box-footer h5 text-white">
                        Compras 
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card  text-white bg-info">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="text-value h4"><strong>${{$total->totalventa}} (DIA ACTUAL) </strong>
                    </div>
                    <div class="h3">Ventas</div>
                </div>
                <div class="chart-wrapper mt-3 mx-3" style="height:35px;">
                    <a href="{{route('sales.index')}}" class="small-box-footer h5 text-white">
                        Ventas 
                        <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! DNS1D::getBarcodeHTML($productosvendido->code, 'C128A'); !!}</td>
